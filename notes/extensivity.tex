...
it has all finite products and coproducts and the functor
\[
...
\end{lemma}
\begin{proof}[Proof]
    Follows directly from the universal property of coproducts, since
    all four triangles commute by definition. Hence 
    there exists a unique arrow $\kappa : X_1\times X_2\to X$, 
    so $f=\kappa=g$.
\end{proof}
