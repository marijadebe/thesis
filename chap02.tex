...
\section{Basic notions}
    In what follows in this section we state and prove some basic facts about pointed acts, following \cite{Kilp00}. We refer the reader to \cite{Kilp00} for a more thorough treatment of pointed acts and their categorical properties.
\begin{definition}
